--AmalgaProd
--december 2018 problem when year 2019
	...
	--SET @enddate = (SELECT end_date FROM AmalgaPROD.dbo.period_nl_view WHERE period_code = '2018PRD8')
	set @enddate = (select end_date
				from period_nl_view
				where MONTH(start_date) = @prevMonth
